...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/vckyou/AVProject.git"
)

# Custom Name Sticker Pack
S_PACK_NAME = os.environ.get("S_PACK_NAME", "Sticker Pack by @GeezSupport")
...
# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "AVProject")
...
# Bot version
BOT_VER = os.environ.get("BOT_VER", "1.0.1")
...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/mrismanaziz/Reforestation/master/blacklistgeez.json"
    )
...
async def update_restart_msg(chat_id, msg_id):
    ...
    message = (
        f"**AVProject v{BOT_VER} is back up and running!**\n\n"
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@SharingUserbot"):
                ...
                result = builder.article(
                    ...
                    text="**Man - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [Risman](https://t.me/mrismanaziz)\n✣ **Support :** @Lunatic0de\n✣ **Repository :** [AVProject](https://github.com/mrismanaziz/AVProject)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("ɢʀᴏᴜᴘ", "https://t.me/SharingUserbot"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ", "https://github.com/mrismanaziz/AVProject"
                            ),
                        ],
                    ],
                    link_preview=False,
