...
@bot.on(avp_cmd(outgoing=True, pattern=r"(d)?fban(?: |$)(.*)"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"unfban(?: |$)(.*)"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"addf(?: |$)(.*)"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"delf$"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"listf$"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"clearf$"))
