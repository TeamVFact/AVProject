...
@bot.on(avp_cmd(outgoing=True, pattern=r"notifoff$"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"notifon$"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"(?:setuju|ok)\s?(.)?"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"(?:tolak|nopm)\s?(.)?"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"block$"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"unblock$"))
...
@bot.on(avp_cmd(outgoing=True, pattern=r"(set|get|reset) pmpermit(?: |$)(\w*)"))
