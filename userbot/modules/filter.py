...
@bot.on(avp_cmd(outgoing=True, pattern="filter (.*)"))
...
@bot.on(avp_cmd(outgoing=True, pattern="filters$"))
...
@bot.on(avp_cmd(outgoing=True, pattern="stop ([\s\S]*)"))
...
@bot.on(avp_cmd(outgoing=True, pattern="rmallfilters$"))
